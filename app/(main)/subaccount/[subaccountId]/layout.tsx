...
const Layout = async ({ children, params }: Props) => {
    ...
    if (!session.role) {
        ...
        if (session.role === "AGENCY_ADMIN" || session.role === "AGENCY_OWNER") {
    ...
    return (
        <div className="h-screen overflow-hidden">
            ...
            <div className="md:pl-[300px]">
                <InfoBar notifications={notifications} role={session.role as string} subAccountId={params.subaccountId as string} />
