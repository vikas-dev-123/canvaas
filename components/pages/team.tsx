...
const TeamSection = () => {
  return (
    <section id="architects" className="py-40 bg-white dark:bg-black/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-32">
          ...
          <h3 className="text-5xl md:text-8xl font-black text-[#1a1a1a] dark:text-white tracking-tighter leading-none">
            Two Brothers. <br />
            <span className="text-slate-200 dark:text-white/20">One Vision.</span>
          </h3>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          {/* Suyash */}
          <div className="depth-card bg-[#fafafa] dark:bg-white/5 p-16 rounded-[2.5rem] border border-black/5 dark:border-white/5 flex flex-col items-center text-center group relative overflow-hidden">
            ...
            <p className="text-lg text-slate-500 dark:text-slate-400 mb-10 leading-relaxed font-medium">
              Redefining the relationship between human creativity and digital structure.
              Suyash focuses on visual fluidness and UX integrity.
            </p>
          </div>
          ...
          <div className="depth-card bg-[#fafafa] dark:bg-white/5 p-16 rounded-[2.5rem] border border-black/5 dark:border-white/5 flex flex-col items-center text-center group relative overflow-hidden">
            ...
            <p className="text-lg text-slate-500 dark:text-slate-400 mb-10 leading-relaxed font-medium">
              Engineering the foundation that powers the vision. Vikash is responsible
              for DAL integrity and global system architecture.
            </p>
          </div>
        </div>
        ...
        <div className="mt-32 text-center">
          ...
          <a
            ...
            className="text-2xl md:text-4xl font-black text-black dark:text-white hover:opacity-60 transition-opacity border-b-4 border-black/10 dark:border-white/10 pb-2"
          >
