...
export const addOnProducts = [
  { title: "Priority Support", id: "prod_TlbsBEgwjUQr4U" },
];

export const icons = [
  { value: "chart", label: "Bar Chart", path: BarChart },
  { value: "headphone", label: "Headphones", path: Headphone },
  ...
  { value: "link", label: "Link", path: LinkIcon },
  { value: "lock", label: "Lock", path: Lock },
  { value: "messages", label: "Messages", path: Message },
  ...
  { value: "category", label: "Category", path: PluraCategory },
  { value: "clipboardIcon", label: "Clipboard Icon", path: ClipboardIcon },
];
